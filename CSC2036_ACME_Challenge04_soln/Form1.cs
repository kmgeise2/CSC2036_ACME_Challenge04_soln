 ...
 * Challenge 4 ACME Packaging Company Add and update workers
 * Solution to Challenge 04
*/
using CSC2036_ACME_Challenge04_soln;
...
namespace CSC2036_ACME_Challenge04
{
    public partial class Form1 : Form
    {
        ...
        //Load the main form with below data.
        ...
        //Delete the selected data from the listbox.
        ...
        //Edit the selected data from the listbox.
        ...
        private void ProcessShift(int i, Employee employee)
        {
            // Create an instance of the Update Production Worker Form
            // Use the Tag field to pass the current employee
            frmUpdateSupervisor f2 = new frmUpdateSupervisor();
            f2.Tag = employee;
            ...
            if (button == DialogResult.OK)
            {
                try
                {
                    ShiftSupervisor tempEmployee = ((ShiftSupervisor)f2.Tag);
                    employees.RemoveAt(i);
                    employees.Insert(i, tempEmployee);
                }
                catch
        ...
        {
            // Create an instance of the Update Team Leader Form
            // Use the Tag field to pass the current employee
            frmUpdateTeamLeader f3 = new frmUpdateTeamLeader();
            f3.Tag = employee;
            DialogResult button = f3.ShowDialog();
            ...
            if (button == DialogResult.OK)
            {
                try
                {
                    TeamLeader tempEmployee = ((TeamLeader)f3.Tag);
                    employees.RemoveAt(i);
                    employees.Insert(i, tempEmployee);
                }
                catch
        ...
        {
            // Create an instance of the Add New Team Leader Form
            frmAddTeamLeader f3 = new frmAddTeamLeader();
            DialogResult button = f3.ShowDialog();

            // Retrieve information if OK is clicked
            if (button == DialogResult.OK)
            {
                employees.Add((TeamLeader)f3.Tag);
                LoadEmployeeListBox();
            }
